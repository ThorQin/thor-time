...
/**
 * @typedef MomentOptions
 * @property {'d'|'h'|'m'|'s'} maxUnit The bigest unit of the description, default is 'd'
 * @property {'d'|'h'|'m'|'s'} minUnit The smallest unit of the description, default is 's'
 */
/**
...
function add(dt, val, unit = 'd') {
	...
	if (unit === 'y') {
		...
		if (d > daysOfMonth(newDate))
			d = daysOfMonth(newDate);
 ...
 * @param {string|number|Date} dt  Date object to be convert
